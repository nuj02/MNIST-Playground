...
## 1. Dimension Reduction Using Autoencoders
...
![Classification of digits using only 2 component PCA](https://github.com/nuj02/Digit-Recognition/blob/main/1\ Dimension\ Reduction\ w/\ Autoencoder/Figures/PCA_Classification.png?raw=true)
